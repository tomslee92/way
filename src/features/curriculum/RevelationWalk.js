...
const T = {
  en: {
    ...
    stop: 'Stop',
    foot: 'Luke 24:27',
    pos: { verse: 'The verse', origin: 'Origin', unfolding: 'Unfolding', moment: 'Jesus’s words', aftermath: 'Echo', consummation: 'Consummation' },
  },
  ko: {
    optional: '선택',
    walk: '어떻게 이어지는지 보기',
    ...
    stop: '멈춤',
    foot: '누가복음 24:27',
    pos: { verse: '본문', origin: '시작', unfolding: '전개', moment: '예수님의 말씀', aftermath: '울림', consummation: '완성' },
  },
};
